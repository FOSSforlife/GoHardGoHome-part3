...
def main():
    ...
    parser.add_argument('--num-games', '-n', help="How many games to play among the bots.", type=int, default=10)
    parser.add_argument('--num-workers', '-w', help="Amount of parallel games to run at a time. Note: it will discard any remainders from num-games/num-workers.\
    i.e. If 20 games are chosen with 3 workers, each worker will run 6 games for a total of 18 actual games.", type=int, default=1)
